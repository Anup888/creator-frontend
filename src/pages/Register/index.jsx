...
import { registerUser } from "../../store/slices/registerUserSlice";
      ...
      <Card color="transparent" shadow={false}>
        ...
        <form className="mt-8 mb-2 w-80 max-w-screen-lg sm:w-96" onSubmit={handleSubmit(onSubmit)}>
          <div className="mb-1 flex flex-col gap-6">
            ...
            />
            {errors.name && <Typography color="red" className="text-sm">{errors.firstName.message}</Typography>}
            ...
            />
            {errors.name && <Typography color="red" className="text-sm">{errors.lastName.message}</Typography>}
